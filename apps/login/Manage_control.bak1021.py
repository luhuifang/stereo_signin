                        ...
                        dbc.Card(
                            dbc.CardBody([
                                    ...
                                    html.Div(className='mennu',children=menus
                                        ...
                                        # html.A(id = 'Check_pending',href='/Manage_coltrol#status=Check_pending',children=[html.P(className='icon'),'Need Check Order'],className="text "),
                                        # html.A(id = 'Verified',href='/Manage_coltrol#status=Verified',children=[html.P(className='icon'),"Checked Order"],className="text "),
                                        ...
                                        # html.A(id = 'end',href='/Manage_coltrol#status=end',children=[html.P(className='icon'),"Finish Order"],className="text "),
...
def page_on_status(href_content,search_href,page_number,search_order_id,search_order_type,search_start_date,search_end_date,page_size):
    ...
    print('status:',status,'search_status:',search_status)
...
@app.callback(
    ...
    # Output('Check_pending','className'),
    # Output('Verified','className'),
    ...
    # Input('Check_pending','n_clicks'),
    # Input('Verified','n_clicks'),
...
def table_shown(\
    #all_order,Check_pending,Verified,Unpaid,Paid,Wait_for_production,In_production,assigned,end,\
    menus_id,hash_name,search_button,first_page,previous_page,next_page,last_page,\
    ...
    # if dash.callback_context.triggered[0]['prop_id'] == 'Check_pending.n_clicks'or dash.callback_context.triggered[0]['value'] == '#status=Check_pending':
    ...
    # if dash.callback_context.triggered[0]['prop_id'] == 'Verified.n_clicks' or dash.callback_context.triggered[0]['value'] == '#status=Verified':
    ...
    # if dash.callback_context.triggered[0]['prop_id'] == 'end.n_clicks' or dash.callback_context.triggered[0]['value'] == '#status=end':
