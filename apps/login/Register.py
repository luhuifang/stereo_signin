...
def formlayout(err_msg='', Username='', Password='',RePassword='',Realname='',Email='',Phone='',District='',Country='',Province='',City='',Organization=''):
...
def update_username(username, new_pw, re_pw):
    u = Users(username)
    if u.checkExists():
...
def update_account(n_clicks,
            ...
            District,Country, Province, City,Organization):
    if not n_clicks :
        raise PreventUpdate
