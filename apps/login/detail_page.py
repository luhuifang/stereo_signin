    ...
    layout = html.Div([
            ...
            html.Div(className='container',children=[
                ...
                html.Div(className='col-md-5 text-right',children=[
                    html.A('CurrentStatus:')
                    ]),
                html.Div(className='col-md-7 text-left',children=[
                    html.A(id={'type':"CurrentStatus_td_detail",'index':f'{order_id}_CurrentStatus_detail'},children=statusDict[data.iloc[0]['CurrentStatus']])
                    ])
                ]),
                html.Div(className='row',children=[
                html.Div(className='col-md-5 text-right',children=[
                ...
                html.Div(className='col-md-7 text-left',children=[
                    html.A(id={'type':"NextStatus_td_detail",'index':f'{order_id}_NextStatus_detail'},children=statusDict[data.iloc[0]['NextStatus']])
                    ])
                ]),
                ...
                dbc.Modal([
                        ...
                        dbc.ModalFooter([
                            dbc.Button("Confirm",
                             ...
                             # href= f'/Manager_console/detail/?orderID={order_id}&{CurrentStatus}',
...
@app.callback(
    [Output({'type':"CurrentStatus_td_detail",'index':ALL}, "children"),
    Output({'type':"NextStatus_td_detail",'index':ALL}, "children"),
...
def change_detail_status(status_confirm,end_confirm,status_id):
    ...
    return currentstatus_res,nextstatus_res,res_status,res_end
