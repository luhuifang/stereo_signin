...
def data_set(value):
    ...
    for i in data_json["1.Filter_and_Map"]["1.1.Adapter_Filter"]:
        if i["Sample_id"] == value:
            mapped_reads = i["mapped_reads"]
            number_reads = i["total_reads"]
            Q30_Barcode = i["Q30_bases_in_barcode"]
            Q30_UMI = i["Q30_bases_in_umi"]
            sample_id = i["Sample_id"]
            Usable_Barcode = i["getBarcodePositionMap_uniqBarcodeTypes"]
            fixed_sequence_contianing_reads = i['fixed_sequence_contianing_reads']
            Barcode_MisOverlap_Reads = i['barcode_misOverlap_reads']
            barcode_withN_reads = i['barcode_withN_reads']
    for i in data_json["1.Filter_and_Map"]["1.2.Filter_Stat"]:
        if i["Sample_Name"] == value:
            clean_reads = i["Clean_Reads"]
            Raw_Reads = i['Raw_Reads']
            Low_Quality_Reads = i['Low_Quality_Reads']
            Too_Many_N_Reads = i['Too_Many_N_Reads']
            Too_Short_Reads = i['Too_Short_Reads']
            Too_Long_Reads = i['Too_Long_Reads']
